...
This is a small list of steps in order to build libass into a msvc DLL and lib file.
...
In order to build libass using msvc you must first download and install YASM.
YASM is required to compile all libass assembly files.
